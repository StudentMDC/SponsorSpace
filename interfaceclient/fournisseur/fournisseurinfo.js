...
const myPromise = new Promise((resolve, reject) => {
  ...
  arrayproduit.forEach((element) => {
    element.addEventListener("click", (eo) => {
      ...
      var dprdinput = document.createElement("input");
      dprdinput.type = "text";
      dprdinput.name = "D[]";
      dprdinput.disabled = true;
      dprdinput.style.border = "1px solid #ccc";
      dprdinput.value = element.children[3].textContent;
      cprd.append(dprdinput);
