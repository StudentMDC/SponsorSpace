...
<body>
  ...
  <div class="sidebar bg-white p-20 p-relative">
      ...
      <ul>
        ...
        <li>
          <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="tousgdo.php">
            <i class="fa-solid fa-diagram-project fa-fw"></i>
  ...
  <div class="content w-full">
    ...
    <!-- /END Head -->
    <h1 class="p-relative ml-15">Tous les grands donneurs d'ordre</h1>
    <div id="wrapper" class="wrapper d-grid gap-20">
      ...
      if (empty($result)) {
        ...
        foreach ($result as $row) {
          if(empty($row["profilimgG"])){
            $row["profilimgG"] = 'avatar.png';
          }
          echo '<div class="welcome bg-white rad-10 txt-c-mobile block-mobile">';
          echo '<img class="avatar" src="../../imgs/'.$row["profilimgG"] .'" alt="">';
          echo '<br>';
