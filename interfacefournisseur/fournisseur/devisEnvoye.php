  ...
  <div class="page d-flex">
    <div class="sidebar bg-white p-20 p-relative">
      ...
      <ul>
        ...
        <li>
          <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="devisEnvoye.php">
    ...
    <div class="content w-full">
      ...
      <!-- /END Head -->
      <h1 class="p-relative ml-15">Devis Envoyées</h1>
      <div class="wrapper">

        <div class="testimonials">
          <p>
            Trouvez tous vos devis en une seule page
          </p>
              ...
              echo  '
                      <div class="content">
                          ...
                          <div class="text">
                            ...
                            <a target="_blank" href="../../mesdevis/' . htmlspecialchars($filename) . '">
